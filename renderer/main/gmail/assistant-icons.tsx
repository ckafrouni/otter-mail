/**
 * Slack mark + an AI sparkle badge — the "hand this off to Hermes in Slack"
 * action. Monochrome (currentColor) so it sits with the lucide line icons.
 * The four-lobe Slack glyph is scaled into the lower-left; the sparkle sits
 * top-right so the intent (send to Slack, AI) reads at a glance.
 */
export function SlackAiIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <g transform="translate(-0.5 2.5) scale(0.74)" fill="currentColor">
      ...
      <path
        d="M19 1.2l.85 1.95L21.8 4l-1.95.85L19 6.8l-.85-1.95L16.2 4l1.95-.85z"
        fill="currentColor"
      />
    </svg>
  );
